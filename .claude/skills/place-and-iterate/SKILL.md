...
Then `Read` the composite PNG (`worlds/$1/iterations/{N:03d}.png`) — Claude sees all three angles as one multimodal input.
...
while iteration < 25:
    ...
    # 3. JUDGE — Claude sees composite + reference together
...
| Judge step (Claude reasoning) | 5-15s |
